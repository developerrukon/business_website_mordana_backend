...
<html lang="en" dir="ltr">
   <head>
      ...
      <!-- Perfect Scrollbar -->
      <link type="text/css" href="<?= admin_url() ?>/css/perfect-scrollbar.css" rel="stylesheet">
      <!-- App CSS -->
      <link type="text/css" href="<?= admin_url() ?>/css/app.css" rel="stylesheet">
      <!-- Material Design Icons -->
      <link type="text/css" href="<?= admin_url() ?>/css/vendor-material-icons.css" rel="stylesheet">
      <!-- Font Awesome FREE Icons -->
     
      <link type="text/css" href="<?= admin_url() ?>/css/vendor-fontawesome-free.css" rel="stylesheet">
   </head>
                     ...
                     <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                        <li class="nav-item dropdown">
                           ...
                           <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                              ...
                              <a class="dropdown-item" href="<?= admin_url()?>/settings/edit_settings_view.php"><i class="material-icons">settings</i>settings</a>
