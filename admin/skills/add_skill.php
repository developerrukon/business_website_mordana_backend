...
echo $skill_percent;
    ...
    //skill percent validation
    if (strlen($skill_percent) >= 50) {
        $error['skill_percent_err'] = "<p  class='alert alert-warning'>Max character number 50.!</p>";
    }
    ...
    if (empty($error)) {
        ...
        $query = "INSERT INTO skills(title, skill_number, skill_percent, skill_color) VALUES ('$title','$skill_number','$skill_percent','$skill_color')";
