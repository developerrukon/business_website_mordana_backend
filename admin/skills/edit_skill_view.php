        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-pen text-primary"></i>Edit Skill</li>
                </ol>
            </nav>
            <h1 class="m-0"><i class="fa fa-pen text-primary"></i>Edit Skill</h1>
        </div>
            ...
            <div class="col-lg-8 card-form__body card-body">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="skill_number" class="form-control" value="<?= $skill['skill_number'] ?>" />
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="skill_color" class="form-control" value="<?= $skill['skill_color'] ?>" />
                        <p>Edit skill color for ex: bg-primary <a href="https://getbootstrap.com/docs/5.0/utilities/background/">helf</a></p>
                        <?php
