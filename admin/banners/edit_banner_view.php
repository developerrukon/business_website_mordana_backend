                                    ...
                                    <div class="col-lg-8 card-form__body card-body">
                                        <form method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control"rows="8" ><?= $banner['description']?></textarea>
                                                <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="btn_text" class="form-control" value="<?= $banner['btn_text']?>"/>
                                                <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="btn_url" class="form-control" value="<?= $banner['btn_url']?>"/>
                                                <?php
