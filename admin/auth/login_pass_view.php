         ...
         <form method="POST">
            <div class="form-group">
               <label class="text-label"
                  for="email_2">Password:</label>
               <div class="input-group input-group-merge">
                  <input id="email_2"  type="password" name="password" class="form-control form-control-prepended" placeholder="enter you password" value="<?php if(isset($password)) echo $password; ?>" />
               </div>
               <?php
