        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add fact</li>
                </ol>
            </nav>
            <h1 class="m-0"><i class="fa fa-user-plus text-primary"></i>Add fact</h1>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-8 card-form__body card-body">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fact_number" class="form-control" value="<?php if (isset($fact_number)) echo $fact_number  ?>" />
                        <?php
                        if (isset($error['fact_number_err'])) {
                            echo $error['fact_number_err'];
                        }
                        ?>
                    </div>
