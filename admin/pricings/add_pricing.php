...
//icon color validation
    ...
    if(empty($error)) {
        ...
        $query = "INSERT INTO pricings(title, pricing_number, pricing_heading, description, btn_text, btn_url) VALUES ('$title','$pricing_number','$pricing_heading','$description','$btn_text','$btn_url')";
