...
<div class="container-fluid page__heading-container">
    <div class="page__heading d-flex align-items-end">
        <div class="flex">
            ...
            <h1 class="m-0"><i class="fa fa-user-plus text-primary"></i>Add Pricing</h1>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-8 card-form__body card-body">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pricing_number" class="form-control" value="<?php if (isset($pricing_number)) echo $pricing_number  ?>" />
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pricing_heading" class="form-control" value="<?php if (isset($pricing_heading)) echo $pricing_heading  ?>" />
                        <?php
